...
int main(){
    ...
    cout << "Enter the amount of money you wish to spend on stamps today: ";
    cin >> initial_money;

    cout << "Enter the num of stamps you want to buy today: ";
    cin >> num_stamps;
    
    // can accept mulyiple values; seperated by whitespace or newline
    // cout << "Enter the amount of money you wish to spend on stamps today and the number of stamps you want to buy: ";
    // cin >> initial_money >> num_stamps;

    // cout << "money = " << initial_money << " stamps = " << num_stamps << endl;
